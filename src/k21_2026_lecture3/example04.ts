...
演習で作るものは、教材サイト利用ログ、受講者アンケート、講義改善計画のいずれかを扱うものに限定してください。
...
const response = await run(
  agent,
  'OpenAI Agents SDK JavaScript TypeScript の tools、structured output、guardrails を、第3回講義の教材サイト利用ログ、受講者アンケート、講義改善計画に結びつく改善題材として調べてください。',
  { maxTurns: 5 }
);
